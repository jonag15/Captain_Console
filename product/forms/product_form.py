...
class ProductCreateForm(ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'quantity': widgets.NumberInput(attrs={'class': 'form-control', 'placeholder': 'Sláðu inn fjölda'}),
            'on_sale': widgets.CheckboxInput(attrs={'class': 'checkbox', 'placeholder': 'Tilboð'}),
